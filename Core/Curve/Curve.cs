...
namespace Framefield.Core.Curve
{
    ...
    public abstract class Curve : OperatorPart.Function, ICurve
    {
        ...
        protected CurveState State
        {
            get
            {
                ...
                {
                    Logger.Error("could not get the CurveState for this Curve op: {0}", ex.Message);
                }
                return null;
            }
        }
